...
exports.run = async (client, msg, args) => {
  ...
  if (!opponent) return msg.reply('Oyunu Oynaya Bileceğin Birisini Etiketlemelisin!')
  if (opponent.bot) return msg.reply('Botlar ile Oyun Oynayamassın!');
        if (opponent.id === msg.author.id) return msg.reply('Kendin ile Oyun Oynayamassın!');
        if (this.games.has(msg.channel.id)) return msg.reply('Aynı Anda Sadece Bir Düello Ola Bilir!');
        ...
        try {
            ...
            if (!verification) {
                ...
                return msg.channel.send('Görünüşe Göre Kabul Etmedi!');
            }
...
exports.help = {
    name: 'xox',
    description: 'X-O-X Oyunu Oynarsınız! 2 Kişiliktir',
    usage: 'cox <@ETİKET>'
}